...
import { getCurrentWeather, getForecast, getWeatherByCoords, getWeatherIcon, formatTemp, getWeatherDescription, SOUTH_AFRICAN_CITIES } from "../services/weatherService";

function WeatherCard({ city = "Benoni" }) {
    ...
    return (
      <div className="card">
        <div className="text-center mb-4">
          ...
          <p className="text-sm text-gray-500">Showing data</p>
        </div>
